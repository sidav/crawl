...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_DJINNI,          SK_SHORT_BLADES,   -1),
    APT(SP_DJINNI,          SK_LONG_BLADES,    -1),
    APT(SP_DJINNI,          SK_AXES,           -2),
    APT(SP_DJINNI,          SK_MACES_FLAILS,   -2),
    APT(SP_DJINNI,          SK_POLEARMS,       -2),
    APT(SP_DJINNI,          SK_STAVES,         -1),
    APT(SP_DJINNI,          SK_SLINGS,         -2),
    APT(SP_DJINNI,          SK_BOWS,           -2),
    APT(SP_DJINNI,          SK_CROSSBOWS,      -2),
    APT(SP_DJINNI,          SK_THROWING,       -2),
    ...
    APT(SP_DJINNI,          SK_CONJURATIONS,  -99),
    APT(SP_DJINNI,          SK_HEXES,         -99),
    APT(SP_DJINNI,          SK_CHARMS,        -99),
    APT(SP_DJINNI,          SK_SUMMONINGS,    -99),
    APT(SP_DJINNI,          SK_NECROMANCY,    -99),
    APT(SP_DJINNI,          SK_TRANSLOCATIONS, -99),
    APT(SP_DJINNI,          SK_TRANSMUTATIONS, -99),
    APT(SP_DJINNI,          SK_FIRE_MAGIC,    -99),
    APT(SP_DJINNI,          SK_ICE_MAGIC,     -99),
    APT(SP_DJINNI,          SK_AIR_MAGIC,     -99),
    APT(SP_DJINNI,          SK_EARTH_MAGIC,   -99),
    APT(SP_DJINNI,          SK_POISON_MAGIC,  -99),
    APT(SP_DJINNI,          SK_INVOCATIONS,     0),
