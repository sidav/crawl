...
static const weapon_def Weapon_prop[NUM_WEAPONS] =
{
    ...
    // Long Blades
    { WPN_FALCHION,              "falchion",               7,  2, 13, 170,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_LITTLE, MI_NONE,
        DAMV_SLICING, 10 },      // or perhaps DAMV_CHOPPING is more apt?
    { WPN_BLESSED_FALCHION,      "blessed falchion",       8,  2, 12, 170,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_LITTLE, MI_NONE,
        DAMV_SLICING, 0 },       // or perhaps DAMV_CHOPPING is more apt?
    { WPN_LONG_SWORD,            "long sword",            9,  1, 14, 160,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_SLICING, 10 },
    { WPN_BLESSED_LONG_SWORD,    "blessed long sword",    10,  0, 13, 160,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_SLICING, 0 },
    { WPN_SCIMITAR,              "scimitar",              11, -2, 14, 170,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_SLICING, 10 },
    { WPN_BLESSED_SCIMITAR,      "blessed scimitar",      12, -3, 13, 170,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_SLICING, 0 },
    { WPN_DEMON_BLADE,           "demon blade",           12, -1, 13, 200,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_SLICING, 2 },
    { WPN_EUDEMON_BLADE,         "eudemon blade",         13, -2, 12, 200,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_SMALL,  MI_NONE,
        DAMV_SLICING, 0 },
    { WPN_BASTARD_SWORD,          "bastard sword",        14, -1, 15, 220,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_MEDIUM, MI_NONE,
        DAMV_SLICING, 2 },
    { WPN_BLESSED_BASTARD_SWORD, "blessed bastard sword", 15, -2, 14, 220,  3,
        SK_LONG_BLADES,  HANDS_ONE,    SIZE_MEDIUM, MI_NONE,
        DAMV_SLICING, 0 },
    { WPN_GREAT_SWORD,           "great sword",           14, -3, 16, 250,  5,
        SK_LONG_BLADES,  HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_SLICING, 10 },
    { WPN_BLESSED_GREAT_SWORD,   "blessed great sword",   15, -4, 15, 250,  5,
        SK_LONG_BLADES,  HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_SLICING, 0 },
    { WPN_CLAYMORE,              "claymore",              17, -4, 19, 260,  5,
        SK_LONG_BLADES,  HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_SLICING, 2 },
    { WPN_BLESSED_CLAYMORE,      "blessed claymore",      18, -5, 18, 260,  5,
        SK_LONG_BLADES,  HANDS_TWO,    SIZE_LARGE,  MI_NONE,
        DAMV_SLICING, 0 },
